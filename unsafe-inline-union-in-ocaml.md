Unsafe Inline Union in OCaml
================================

<center>Draft</center>

I was reading LexiFi blog post [about unboxed float arrays][LexiFi],
which mentions an interesting potential compiler optimization.
You may remember that OCaml compiles `int`s, `bool`s, `unit`, and
variants without constructor to 63 bit integers (on 64 bit platforms)
and leaves one bit to distinguish between such integers and pointer types.
That means
...
[LexiFi]: https://www.lexifi.com/blog/about-unboxed-float-arrays
